...
random_polytechnic_name = naija.polytechnic(location="Plateau")
print("Random polytechnic name in Plateau:", random_polytechnic_name)

# Get a random polytechnic acronym at a specific location
polytechnic_acronym = naija.polytechnic(acronym=True, location="Plateau")
print("Random polytechnic acronym in Plateau:", polytechnic_acronym)
